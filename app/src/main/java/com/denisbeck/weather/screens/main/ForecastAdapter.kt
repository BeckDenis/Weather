...
class ForecastAdapter(
    ...
    companion object {
        private val TAG = ForecastAdapter::class.java.simpleName
    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.view.run {
            ...
            item_forecast_icon.setImageDrawable(context.getDrawable(weatherIconLowQ(weather.weather.first().icon)))
            item_forecast_temp.text = context.getString(R.string.temp, weather.main.temp)
